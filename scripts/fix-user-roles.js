...
async function fixUserRoles() {
  try {
    ...
    if (users.length === 0) {
      console.log('ℹ️  No users found. You may need to create a user first.\n');
      console.log('💡 To create an admin user, use the signup API:');
      console.log('   POST /api/auth/signup');
      console.log('   Body: { "name": "Admin", "email": "admin@example.com", "password": "password123", "role": "admin" }\n');
      return;
    }
